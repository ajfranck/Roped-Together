...
public class Healing : MonoBehaviour
{
    ...
    void Update()
    {
        if (player1 && Input.GetKey("e") && HotBars.HotBarListP1[HotBars.HotBarPositionP1] != null && HotBars.HotBarListP1[HotBars.HotBarPositionP1].name == "BowlItem" && !mining.isMining && !warmthbar.isInteracting)
        {
            StartCoroutine(UseIt(player1));
        }
        else if(Input.GetKey("e") && HotBars.HotBarListP2[HotBars.HotBarPositionP2] != null && HotBars.HotBarListP2[HotBars.HotBarPositionP2].name == "BowlItem" && !mining.isMining && !warmthbar.isInteracting)
        {
            StartCoroutine(UseIt(player1));
        }
    }
